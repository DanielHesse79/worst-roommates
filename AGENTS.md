...
- `js/view.js`, `models.js`, `lot.js`, `interior.js` (wallpaper, paintings, ceilings and lamps), `decor.js`, `garden.js`, and `effects.js` handle rendering and procedural assets; `js/ui.js` manages the interface.
