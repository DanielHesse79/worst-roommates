...
export const CAUSE_VERB = {
  ...
  'Letter Bomb': 'open a letter bomb', Boredom: 'be bored to death', Laughter: 'die laughing',
};
...
const CAUSE_PAST = {
  ...
  'Letter Bomb': 'was killed by a letter bomb', Boredom: 'was bored to death', Laughter: 'died laughing',
};
